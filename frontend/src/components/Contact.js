              ...
              <div class="branch-info-item">
                ...
                <div class="branch-info-body box--shadow">
                  <ul class="text-center">
                    <li>Address: 24, Aba Hart St., Spintex, Ghana</li>
                    <li>Email: info.example@gmail.com</li>
                    <li>Phone: +233 54 200 0000</li>
            ...
            <div class="col-lg-4 col-md-6">
              <div class="branch-info-item">
                ...
                <div class="branch-info-body box--shadow">
                  <ul class="text-center">
                    <li>
                      Address: 150 lane Nandom National Park, Ghana
                    </li>
                    <li>Email: info.example@gmail.com</li>
                    <li>Phone: +233 54 210 0000</li>
                    <li>Web: www.yourwebsite.com</li>
                  </ul>
                </div>
              </div>
            ...
            <div class="col-lg-4 col-md-6">
              <div class="branch-info-item">
                ...
                <div class="branch-info-body box--shadow">
                  <ul class="text-center">
                    <li>
                      Address: 25 Navana lane, Kumasi, Ghana
                    </li>
                    <li>Email: info.example@gmail.com</li>
                    <li>Phone: +233 54 220 0000</li>
                    <li>Web: www.yourwebsite.com</li>
                  </ul>
                </div>
              </div>
