  ...
  return (
    <Fragment>
      {loading ? (
        ...
        <Fragment>
          <MetaData title={"tome- Your Best Online Shop"} />
          {ishome && (
            <Banner
              src="https://res.cloudinary.com/hba-solver/image/upload/v1657880938/banner/bg1_jszeky.png"
              search="true"
              text="Enjoy Shopping At The Best Value For Money"
              text2="Get your products delivered at your door steps all day everyday"
            />
          )}
